...
with DAG(
	dag_id='ds_weather_prediction_project',
	description='This is auto crawler tool to grab weather data in wunderground.com',
	default_args=default_args,
	start_date=datetime(2023, 1, 31, 23, 45, 0, 0, pytz.timezone("Asia/Ho_Chi_Minh")),
	schedule='45 23 * * *'
) as dag:
	...
	# 	task_id='prediction',
	# 	bash_command="source /Users/hadoop/Downloads/ds-proj/ds/bin/activate && python /Users/hadoop/Downloads/ds-proj/scripts/model.py $(ls -td model* | head -1)"
	# )

	crawl >> normalize >> insert2ES
